...
// NewBBSPlusTupleGenerator returns a new BBSPlusTupleGenerator.
...
func (t *BBSPlusTupleGenerator) GenBBSPlusTuple(root *bls12381.Fr) *BBSPlusTuple {
	...
	return NewBBSPlusTuple(t.skShare, aiElement, eiElement, siElement, alphaiElement, deltaiElement, delta0iElement, delta1iElement)
}
...
type BBSPlusTuple struct {
	...
	Delta0Share *bls12381.Fr
	Delta1Share *bls12381.Fr
}

// EmptyTuple returns an empty BBSPlusTuple.
// The amount of AeTerms, SeTerms and AskTerms is determined by s.
func NewBBSPlusTuple(SkShare, AShare, EShare, SShare, AlphaShare, DeltaShare, Delta0Share, Delta1Share *bls12381.Fr) *BBSPlusTuple {
	tuple := &BBSPlusTuple{
		...
		Delta0Share: bls12381.NewFr(),
		Delta1Share: bls12381.NewFr(),
	}
	...
	tuple.Delta0Share.FromBytes(Delta0Share.ToBytes())
	tuple.Delta1Share.FromBytes(Delta1Share.ToBytes())
	return tuple
}
