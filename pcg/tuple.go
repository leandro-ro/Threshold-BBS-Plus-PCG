...
func NewSeparateBBSPlusTupleGenerator(u []*poly.Polynomial, uk, uv [][]*poly.Polynomial, SkShare *bls12381.Fr, APoly, EPoly, SPoly *poly.Polynomial, AlphaPoly, Delta1Poly []*poly.Polynomial, Delta0Poly [][]*poly.Polynomial) *SeparateBBSPlusTupleGenerator {
