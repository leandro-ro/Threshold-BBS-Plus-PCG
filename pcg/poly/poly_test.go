...
func BenchmarkMulSparseNaiveD262144T5632(t *testing.B) { benchmarkMulSparseNaive(t, 262144, 5632) }
...
func BenchmarkMulSparseFFTD262144T5632(t *testing.B) { benchmarkMulSparseFFT(t, 262144, 5632) }
